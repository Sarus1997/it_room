...
<body class="body-wrapper">
                ...
                <div class="col-md-6">
                    <div class="page-banner__content mb-xs-10 mb-sm-15 mb-md-15 mb-20">
                        ...
                        <div class="page-title">
                            <h1>IT Team <span><br>Dashboad</span></h1>
                        </div>
                    </div>
    ...
    <section class="team pb-xs-40 pt-xs-40 pt-sm-50 pb-sm-50 pt-md-50 pb-md-50 pt-60 pb-75 overflow-hidden">
        ...
        <div class="container-fluid">
            <iframe src="https://view.monday.com/embed/4164184865-c446a29e1b32534c831ae77de313bd7c?r=use1" width=100% height=1000px style="border: 1; box-shadow: 5px 5px 56px 0px  rgba(204,204,204,1);"></iframe>
        </div>
